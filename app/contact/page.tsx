...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contact Vento Cafe through WhatsApp and Instagram."
};
    ...
    <section className="mx-auto w-full max-w-7xl px-5 py-14 sm:px-8 sm:py-20">
      <div className="grid gap-7 lg:grid-cols-[1.1fr_1fr]">
        <div className="rounded-3xl border border-espresso/10 bg-white/60 p-7 shadow-soft sm:p-10">
          <p className="text-xs uppercase tracking-[0.28em] text-forest">Contact</p>
          <h1 className="mt-3 text-4xl font-semibold text-espresso sm:text-5xl">Let’s Share a Coffee Moment</h1>
          <p className="mt-4 text-matte/75">
            Reach out to us for orders, questions, or collaborations. We are always happy to connect.
          </p>
